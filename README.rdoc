...
Last revised on Friday 9th October, 2009.
...
As of version 1.2, the command-line script supports an <kbd>--encoding</kbd>
...
pass the <kbd>--encoding</kbd> option on the command line; otherwise, you
need to supply the proper character encoding in order to have the script
correctly recognize and produce HTML code.
...
run by the +rake fitspec+ command. The second file is named
...
if the proper <kbd>--encoding=windows-1252</kbd> option is supplied.
